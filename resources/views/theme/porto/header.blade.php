                            ...
                            <div class="megamenu megamenu-fixed-width">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="banner">
                                            <a href="#">
                                                <img src="{{asset("assets/$theme/images/menu-banner-2.jpg")}}" alt="Menu banner">
                                            </a>
                                        </div><!-- End .banner -->
                                    </div><!-- End .col-lg-4 -->
                                </div>
                            ...
                            <div class="megamenu">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="banner">
                                            <a href="#">
                                                <img src="{{asset("assets/$theme/images/menu-banner.jpg")}}" alt="Menu banner" class="product-promo">
                                            </a>
                                        </div><!-- End .banner -->
                                    </div><!-- End .col-lg-4 -->
                                </div><!-- End .row -->
                        ...
                        <div class="dropdownmenu-wrapper">
                            <div class="dropdown-cart-products">
                                <div class="product">
                                    ...
                                    <figure class="product-image-container">
                                        <a href="product.html" class="product-image">
                                            <img src="{{asset("assets/$theme/images/products/cart/product-1.jpg")}}" alt="product">
                                        </a>
                                ...
                                <div class="product">
                                    ...
                                    <figure class="product-image-container">
                                        <a href="product.html" class="product-image">
                                            <img src="{{asset("assets/$theme/images/products/cart/product-2.jpg")}}" alt="product">
                                        </a>
                                        <a href="#" class="btn-remove" title="Remove Product"><i class="icon-cancel"></i></a>
                                    </figure>
                                </div><!-- End .product -->
